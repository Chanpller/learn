...
![](D:\迅雷下载\Learning-in-practice-master\Redis\3.redis10大数据类型\images\11.key区分大小写.jpg)
...
![](D:\迅雷下载\Learning-in-practice-master\Redis\3.redis10大数据类型\images\12.help命令.jpg)
...
![](D:\迅雷下载\Learning-in-practice-master\Redis\3.redis10大数据类型\images\51.zset-zrange.png)

##### 3.zrevrange key start stop [WITHSCORES]

反转集合，按照元素分数从大到小的顺序返回索引从start到stop之间的所有元素

![](D:\迅雷下载\Learning-in-practice-master\Redis\3.redis10大数据类型\images\52.zset-zrevrange.png)
...
![](D:\迅雷下载\Learning-in-practice-master\Redis\3.redis10大数据类型\images\53.zset-zrangebyscore.png)
...
![](D:\迅雷下载\Learning-in-practice-master\Redis\3.redis10大数据类型\images\54.zset-zcard.png)

##### 7. zrem key member [member ...]

某个score对应的value值，作用是删除元素

![](D:\迅雷下载\Learning-in-practice-master\Redis\3.redis10大数据类型\images\55.zset-zrem.png)

##### 8.ZINCRBY key increment member

增加某个元素的分数

![](D:\迅雷下载\Learning-in-practice-master\Redis\3.redis10大数据类型\images\56.zset-incrby.png)

##### 9.ZCOUNT key min max

获得指定分数内的元素个数

![](D:\迅雷下载\Learning-in-practice-master\Redis\3.redis10大数据类型\images\57.zset-zcount.png)

##### 10.ZMPOP numkeys key [key ...] MIN|MAX [COUNT count]

从键名列表中的**第一个非空排序集中弹出一个或多个元素**，他们是成员分数对

![](D:\迅雷下载\Learning-in-practice-master\Redis\3.redis10大数据类型\images\58.zset-zmpop.jpg)
...
![](D:\迅雷下载\Learning-in-practice-master\Redis\3.redis10大数据类型\images\59.zset-zrank.png)
...
![](D:\迅雷下载\Learning-in-practice-master\Redis\3.redis10大数据类型\images\60.zset-bitarrays.jpg)
...
![](D:\迅雷下载\Learning-in-practice-master\Redis\3.redis10大数据类型\images\61.bitmap基本命令.jpg)
...
![](D:\迅雷下载\Learning-in-practice-master\Redis\3.redis10大数据类型\images\62.Bitmap-setbit示意图.jpg)



![](D:\迅雷下载\Learning-in-practice-master\Redis\3.redis10大数据类型\images\63.Bitmap-setbit.jpg)

##### 2.getbit key offset

获取键偏移位的值

![](D:\迅雷下载\Learning-in-practice-master\Redis\3.redis10大数据类型\images\64.Bitmap-getbit.jpg)

##### 3.strlen key

统计字节数占用多少

![](D:\迅雷下载\Learning-in-practice-master\Redis\3.redis10大数据类型\images\65.Bitmap-strlen.jpg)
...
![](D:\迅雷下载\Learning-in-practice-master\Redis\3.redis10大数据类型\images\66.Bitmap-bitcount.jpg)
...
![](D:\迅雷下载\Learning-in-practice-master\Redis\3.redis10大数据类型\images\67.Bitmap-bitop1.jpg)

![](D:\迅雷下载\Learning-in-practice-master\Redis\3.redis10大数据类型\images\67.Bitmap-bitop2.jpg)
...
![](D:\迅雷下载\Learning-in-practice-master\Redis\3.redis10大数据类型\images\69.HyperLogLog常用命令.jpg)



![](D:\迅雷下载\Learning-in-practice-master\Redis\3.redis10大数据类型\images\70.HyperLogLog命令演示.jpg)
...
1. List实现消息队列，List实现方式其实就是点对点的模式
   ...
   ![](D:\迅雷下载\Learning-in-practice-master\Redis\3.redis10大数据类型\images\78.List实现消息队列.png)

2. Pub/Sub

![](D:\迅雷下载\Learning-in-practice-master\Redis\3.redis10大数据类型\images\79.pub、sub.png)
...
![](D:\迅雷下载\Learning-in-practice-master\Redis\3.redis10大数据类型\images\80.stream结构.png)

一个消息链表，将所有加入的消息都串起来，每个消息都有一个唯一的ID和对应的内容

![](D:\迅雷下载\Learning-in-practice-master\Redis\3.redis10大数据类型\images\81.stream消息队列.png)

#### 基本命令理论简介

##### 队列相关指令

![](D:\迅雷下载\Learning-in-practice-master\Redis\3.redis10大数据类型\images\82.队列相关指令.png)

##### 消费组相关指令

![](D:\迅雷下载\Learning-in-practice-master\Redis\3.redis10大数据类型\images\83.消费组相关指令.png)
...
![](D:\迅雷下载\Learning-in-practice-master\Redis\3.redis10大数据类型\images\84.Stream-XADD.png)
...
![](D:\迅雷下载\Learning-in-practice-master\Redis\3.redis10大数据类型\images\85.Stream-XRANGE.png)

##### 3.XREVRANGE key end start [COUNT count]

根据ID降序输出

![](D:\迅雷下载\Learning-in-practice-master\Redis\3.redis10大数据类型\images\86.Stream-XREVRANGE.png)

##### 4.XDEL key id [id ...]

![](D:\迅雷下载\Learning-in-practice-master\Redis\3.redis10大数据类型\images\87.Stream-XDEL.png)

##### 5.XLEN key

![](D:\迅雷下载\Learning-in-practice-master\Redis\3.redis10大数据类型\images\88.Stream-XLEN.png)
...
![](D:\迅雷下载\Learning-in-practice-master\Redis\3.redis10大数据类型\images\89.Stream-xtrim.png)
...
- 0-0代表从最小的ID开始获取Stream中的消息，当不指定count，将会返回Stream中的所有消息，注意也可以使用0 (00/000也都是可以的)
  ...
  ![](D:\迅雷下载\Learning-in-practice-master\Redis\3.redis10大数据类型\images\90.Stream-xread非阻塞.png)

**阻塞**

![](D:\迅雷下载\Learning-in-practice-master\Redis\3.redis10大数据类型\images\91.Stream-xread阻塞.png)

小总结（类似Java里面的阻塞队列）

Stream的基础方法，使用XADD存入消息和XREAD循环阻塞读取消息的方式可以实现简易版的消息队列

![](D:\迅雷下载\Learning-in-practice-master\Redis\3.redis10大数据类型\images\92.Stream-XREAD总结.png)
...
![](D:\迅雷下载\Learning-in-practice-master\Redis\3.redis10大数据类型\images\93.Stream-xgroup.png)''

##### 2.XREADGROUP GROUP group  \[COUNT count] [BLOCK milliseconds] STREAMS key id 

">"，表示从第一条尚未被消费的消息开始读取

![](D:\迅雷下载\Learning-in-practice-master\Redis\3.redis10大数据类型\images\94.同组消费者.png)

消费组groupA内的消费者consumer1从mystream消息队列中读取所有消息

但是，**不同消费组**的消费者可以消费同一条消息

![](D:\迅雷下载\Learning-in-practice-master\Redis\3.redis10大数据类型\images\95.不同组消费组.png)

消费组的目的？

让组内的多个消费者共同分担读取消息，所以，我们通常会让每个消费者读取部分消息，从而实现消息读取负载在多个消费者间是均衡分部的

![](D:\迅雷下载\Learning-in-practice-master\Redis\3.redis10大数据类型\images\96.消息读取负载均衡.png)
...
![](D:\迅雷下载\Learning-in-practice-master\Redis\3.redis10大数据类型\images\97.消息ack.png)

##### 3.XPENDING 

查询每个消费组内所有消费组[已读取、但尚未确认]的消息

![](D:\迅雷下载\Learning-in-practice-master\Redis\3.redis10大数据类型\images\98.Stream-XPENDING.png)

查看某个消费组具体读取了那些数据

![](D:\迅雷下载\Learning-in-practice-master\Redis\3.redis10大数据类型\images\99.Stream-XPENDING.png)

##### 4.XACK key group id [id...]

向消息队列确认消息处理已完成

![](D:\迅雷下载\Learning-in-practice-master\Redis\3.redis10大数据类型\images\100.Stream-XACK.jpg)



##### XINFO 用于打印Stream\Consumer\Group的详细信息 

![](D:\迅雷下载\Learning-in-practice-master\Redis\3.redis10大数据类型\images\101.Stream-XINFO.jpg)
