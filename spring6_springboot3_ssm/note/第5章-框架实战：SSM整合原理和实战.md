...
public class MapperJavaConfigNew {
    ...
    public SqlSessionFactoryBean sqlSessionFactoryBean(DataSource dataSource){
		...
		//写xml配置，或者在resource下创建与EmployeeMapper类相同的包，将xml放到该包下，就不需要通过setMapperLocations设置了
        Resource resource = new ClassPathResource("mappers/EmployeeMapper.xml");
