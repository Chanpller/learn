...
![image-20241023200316398](../image/image-20241023200316398.png)
...
![image-20241023200413558](../image/image-20241023200413558.png)
...
![image-20241023200625603](../image/image-20241023200625603.png)
...
xml配置文件编写，文件：resources/spring-bean-01.xml
...
![image-20241023222727455](../image/image-20241023222727455.png)
...
![image-20241023224803273](../image/image-20241023224803273.png)
...
![image-20241023225520521](../image/image-20241023225520521.png)

#### 2.4.2.6 实验六： 基于XML方式整合三层架构组件
...
![image-20241023232823899](../image/image-20241023232823899.png)
...
- 代理：将非核心逻辑离出来以后，封装这些非核心逻辑的类、对象、方法。(中介)
  - 动词：指做代理这个动作，或这项工作
  - 名词：扮演代理这个角色的类、对象、方法
...
![image-20241024221519348](../image/2-42.png)

  ### 2.5.4 Spring AOP框架介绍和关系梳理
...
3. Spring AOP框架，基于AOP编程思维，封装动态代理技术，简化动态代理技术实现的框架！SpringAOP内部帮助我们实现动态代理，我们只需写少量的配置，指定生效范围即可,即可完成面向切面思维编程的实现！
  ...
  ### 2.5.5 Spring AOP基于注解方式实现和细节

#### 2.5.5.1 Spring AOP底层技术组成
...
3、配置切点表达式【选中要插入的方法也就是切点】
4、补全注解
	加入ioc容器@Component
	配置切面 @Aspect = 切点+增强
spring aop 重点是配置  ，实现是是 jdk|cglib的动态代理
...
5、开启aspect注解的支持（开启自动代理）
//注解@EnableAspectJAutoProxy 配置类上开启 Aspectj注解支持!
//作用等于 <aop:aspectj-autoproxy /> 
```
...
特殊情况 不考虑 访问修饰符和返回值，写一个星号即可。
	execution(* * ) 这是错误语法
    execution(*) 正确写法，== 你只要考虑返回值 或者 不考虑访问修饰符 相当于全部不考虑了
...
![image-20241024225430326](../image/2-43.png)

有接口：

![image-20241024225706828](../image/2-44.png)
