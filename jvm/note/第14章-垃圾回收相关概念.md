...
2. 然而System.gc()调用附带一个免责声明，无法保证对垃圾收集器的调用(不能确保立即生效，GC什么时候回收无法确定)
...
<img src="../image/chapter14/0001.png">
...
执行 System.gc() 仅仅是将年轻代的 buffer 数组对象放到了老年代，buffer对象仍然没有回收(ParOldGen 增加了10M)，因为是方法栈帧的引用，是GCRoot对象，所以没被回收掉。如果出了方法再调用GC，栈弹出，就没有引用了就会GC。

```java
[GC (System.gc()) [PSYoungGen: 16794K->10744K(76288K)] 16794K->11112K(251392K), 0.0064436 secs] [Times: user=0.03 sys=0.00, real=0.02 secs] 
[Full GC (System.gc()) [PSYoungGen: 10744K->0K(76288K)] [ParOldGen: 368K->11059K(175104K)] 11112K->11059K(251392K), [Metaspace: 3338K->3338K(1056768K)], 0.0061063 secs] [Times: user=0.00 sys=0.00, real=0.00 secs] 
Heap
 PSYoungGen      total 76288K, used 437K [0x00000000fab00000, 0x0000000100000000, 0x0000000100000000)
  eden space 65536K, 0% used [0x00000000fab00000,0x00000000fab6d518,0x00000000feb00000)
 ...
 ParOldGen       total 175104K, used 11059K [0x00000000f0000000, 0x00000000fab00000, 0x00000000fab00000)
  object space 175104K, 6% used [0x00000000f0000000,0x00000000f0accd98,0x00000000fab00000)
...
由于 buffer 数组对象主动释放了引用，没有引用指向它，执行 System.gc() 将被回收，没有放入到 ParOldGen区，因为是方法栈帧的引用，是GCRoot对象。

```java
[GC (System.gc()) [PSYoungGen: 16794K->856K(76288K)] 16794K->864K(251392K), 0.0030668 secs] [Times: user=0.00 sys=0.00, real=0.00 secs] 
[Full GC (System.gc()) [PSYoungGen: 856K->0K(76288K)] [ParOldGen: 8K->819K(175104K)] 864K->819K(251392K), [Metaspace: 3337K->3337K(1056768K)], 0.0065918 secs] [Times: user=0.00 sys=0.00, real=0.00 secs] 
Heap
 PSYoungGen      total 76288K, used 437K [0x00000000fab00000, 0x0000000100000000, 0x0000000100000000)
  eden space 65536K, 0% used [0x00000000fab00000,0x00000000fab6d518,0x00000000feb00000)
  from space 10752K, 0% used [0x00000000feb00000,0x00000000feb00000,0x00000000ff580000)
  to   space 10752K, 0% used [0x00000000ff580000,0x00000000ff580000,0x0000000100000000)
 ParOldGen       total 175104K, used 819K [0x00000000f0000000, 0x00000000fab00000, 0x00000000fab00000)
  object space 175104K, 0% used [0x00000000f0000000,0x00000000f00ccd88,0x00000000fab00000)
...
虽然出了代码块的作用域，但是 buffer 数组对象并没有被回收，放入了ParOldGen区，因为是匿名代码块，也是需要占用本地方法变量表，栈帧中的本地变量表引用，是GCRoot对象，所以没有回收。

```java
[GC (System.gc()) [PSYoungGen: 15483K->10744K(76288K)] 15483K->11104K(251392K), 0.0060564 secs] [Times: user=0.00 sys=0.00, real=0.00 secs] 
[Full GC (System.gc()) [PSYoungGen: 10744K->0K(76288K)] [ParOldGen: 360K->11015K(175104K)] 11104K->11015K(251392K), [Metaspace: 3063K->3063K(1056768K)], 0.0091021 secs] [Times: user=0.00 sys=0.00, real=0.00 secs] 
Heap
 PSYoungGen      total 76288K, used 1966K [0x00000000fab00000, 0x0000000100000000, 0x0000000100000000)
  ...
  from space 10752K, 0% used [0x00000000feb00000,0x00000000feb00000,0x00000000ff580000)
  to   space 10752K, 0% used [0x00000000ff580000,0x00000000ff580000,0x0000000100000000)
 ParOldGen       total 175104K, used 11015K [0x00000000f0000000, 0x00000000fab00000, 0x00000000fab00000)
  object space 175104K, 6% used [0x00000000f0000000,0x00000000f0ac1cf0,0x00000000fab00000)
...
<img src="../image/chapter14/0002.png">
...
<img src="../image/chapter14/0003.png">

3、那么这种代码块的情况，什么时候会被GC呢？我们来看第四个方法

**4、调用 localvarGC4() 方法**

ParOldGen区没有增加内存，被回收掉了

```java
[GC (System.gc()) [PSYoungGen: 15483K->944K(76288K)] 15483K->952K(251392K), 0.0010379 secs] [Times: user=0.00 sys=0.00, real=0.00 secs] 
[Full GC (System.gc()) [PSYoungGen: 944K->0K(76288K)] [ParOldGen: 8K->788K(175104K)] 952K->788K(251392K), [Metaspace: 3227K->3227K(1056768K)], 0.0043536 secs] [Times: user=0.00 sys=0.00, real=0.00 secs] 
Heap
 PSYoungGen      total 76288K, used 1966K [0x00000000fab00000, 0x0000000100000000, 0x0000000100000000)
  eden space 65536K, 3% used [0x00000000fab00000,0x00000000faceb9f0,0x00000000feb00000)
  from space 10752K, 0% used [0x00000000feb00000,0x00000000feb00000,0x00000000ff580000)
  to   space 10752K, 0% used [0x00000000ff580000,0x00000000ff580000,0x0000000100000000)
 ParOldGen       total 175104K, used 788K [0x00000000f0000000, 0x00000000fab00000, 0x00000000fab00000)
  object space 175104K, 0% used [0x00000000f0000000,0x00000000f00c5180,0x00000000fab00000)
...
<img src="../image/chapter14/0004.png">

<img src="../image/chapter14/0005.png">
...
```java
[GC (System.gc()) [PSYoungGen: 15483K->10728K(76288K)] 15483K->11088K(251392K), 0.0056736 secs] [Times: user=0.00 sys=0.00, real=0.00 secs] 
[Full GC (System.gc()) [PSYoungGen: 10728K->0K(76288K)] [ParOldGen: 360K->11024K(175104K)] 11088K->11024K(251392K), [Metaspace: 3203K->3203K(1056768K)], 0.0062812 secs] [Times: user=0.00 sys=0.00, real=0.00 secs] 
[GC (System.gc()) [PSYoungGen: 1310K->64K(76288K)] 12335K->11088K(251392K), 0.0002483 secs] [Times: user=0.00 sys=0.00, real=0.00 secs] 
[Full GC (System.gc()) [PSYoungGen: 64K->0K(76288K)] [ParOldGen: 11024K->782K(175104K)] 11088K->782K(251392K), [Metaspace: 3203K->3203K(1056768K)], 0.0041110 secs] [Times: user=0.05 sys=0.00, real=0.02 secs] 
Heap
 PSYoungGen      total 76288K, used 1966K [0x00000000fab00000, 0x0000000100000000, 0x0000000100000000)
  eden space 65536K, 3% used [0x00000000fab00000,0x00000000faceba00,0x00000000feb00000)
 ...
 ParOldGen       total 175104K, used 782K [0x00000000f0000000, 0x00000000fab00000, 0x00000000fab00000)
  object space 175104K, 0% used [0x00000000f0000000,0x00000000f00c3b60,0x00000000fab00000)
...
<img src="../image/chapter14/0006.png">
...
<img src="../image/chapter14/0007.png">
...
<img src="../image/chapter14/0008.png">

> **并发与并行的对比**

1. 并发，指的是多个事情，在同一时**间段内**同时发生了。
2. 并行，指的是多个事情，在同一时**间点上**（或者说同一时刻）同时发生了。
...
<img src="../image/chapter14/0009.png">
...
<img src="../image/chapter14/0010.png">

### 14.4.4 HotSpot的算法实现细节
...
* 记忆集从非收集区域（比如年老代，很少收集垃圾）指向收集区（比如年轻代，收集拉垃圾）域的指针集合的抽象数据结构，就是用来记录跨代引用的表。

* 如老年代的对象引用了新生代的对象，在回收新生代时，判断没有引用可能被回收，但是还有老年代的引用，就不能被回收。需要遍历整个老年代才知道有没有引用新生代，但这种跨代引用较少，遍历整个老年代不划算。

* 卡表是记忆集的实现方式：每个记录精确到一块内存区域，该区域内有对象含有跨代指针，而不用记录每个对象是不是有跨代引用。

#### 14.5.1.1 什么是跨代引用？

1、一般的垃圾回收算法至少会划分出两个年代，年轻代和老年代。但是单纯的分代理论在垃圾回收的时候存在一个巨大的缺陷：为了找到年轻代中的存活对象，却不得不遍历整个老年代，反过来也是一样的。

<img src="../image/chapter14/0011.png">
...
<img src="../image/chapter14/0012.png" >
...
<img src="../image/chapter14/0013.png">
