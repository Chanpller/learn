...
![image-20231108223456963](../image/0013.png)
...
4.  某线程调用Runtime类或System类的exit()方法，或Runtime类的halt()方法（三个方法底层都是同一个方法Shutdown的halt方法），并且Java安全管理器也允许这次exit()或halt()操作。
