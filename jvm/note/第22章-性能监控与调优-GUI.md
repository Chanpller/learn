...
![image-20240330143433061](../image/chapter22/image-20240330143433061.png)
...
* 支配树的边与对象引用图的边不直接对应。
  ...
  ![image-20240330154536397](../image/chapter22/image-20240330154536397.png)
...
![image-20240330155448411](../image/chapter22/image-20240330155448411.png)

![image-20240330155512210](../image/chapter22/image-20240330155512210.png)

![image-20240330155531698](../image/chapter22/image-20240330155531698.png)

![image-20240330155551579](../image/chapter22/image-20240330155551579.png)

![image-20240330155618377](../image/chapter22/image-20240330155618377.png)

![image-20240330155643282](../image/chapter22/image-20240330155643282.png)

![image-20240330155703650](../image/chapter22/image-20240330155703650.png)

![image-20240330155722586](../image/chapter22/image-20240330155722586.png)
...
![image-20240330160415640](../image/chapter22/image-20240330160415640.png)
...
![image-20240330164358817](../image/chapter22/image-20240330164358817.png)
...
![image-20240330165128035](../image/chapter22/image-20240330165128035.png)

![image-20240330165154299](../image/chapter22/image-20240330165154299.png)
...
![image-20240409122529350](../image/chapter22/image-20240409122529350.png)
...
![image-20240409122733356](../image/chapter22/image-20240409122733356.png)

* Jprofiler中配置IDEA

  ![image-20240410081028695](../image/chapter22/image-20240410081028695.png)

  ![image-20240410081157860](../image/chapter22/image-20240410081157860.png)

  ![image-20240410082949846](../image/chapter22/image-20240410082949846.png)

* IDEA集成Jprofiler

![image-20240410081425223](../image/chapter22/image-20240410081425223.png)

![image-20240410081351245](../image/chapter22/image-20240410081351245.png)

### 22.5.3 具体使用

![image-20240410083412288](../image/chapter22/image-20240410083412288.png)
...
![image-20240410105034544](../image/chapter22/image-20240410105034544.png)

![image-20240410105056632](../image/chapter22/image-20240410105056632.png)

#### 22.5.3.2 遥感监测Telementries
...
![image-20240410111521394](../image/chapter22/image-20240410111521394.png)

#### 22.5.3.3 内存视图Live Memory

内存剖析：class/class instance的相关西悉尼。例如对象的个数、大小、对象创建的方法执行栈，对象创建的热点。

* 所有的对象All Objects
  * 显示所有加载的类列表和在堆上分配的实例数。只有Java 1.5（JVMTI）才会显示此视图
  * ![image-20240410112328961](../image/chapter22/image-20240410112328961.png)
* 记录对象Record Objects
...
![image-20240410113155415](../image/chapter22/image-20240410113155415.png)

#### 22.5.3.4 堆遍历 heap walker
...
![image-20240410121815568](../image/chapter22/image-20240410121815568.png)

#### 22.5.3.5 CPU视图 cpu views

![image-20240410122046145](../image/chapter22/image-20240410122046145.png)

#### 22.5.3.6 线程视图 threads
...
![image-20240410122725087](../image/chapter22/image-20240410122725087.png)

#### 22.5.3.7 监视器&锁 Monitors&locks
...
![image-20240410123330668](../image/chapter22/image-20240410123330668.png)
...
![image-20240411085356034](../image/chapter22/image-20240411085356034.png)

![image-20240411085330582](../image/chapter22/image-20240411085330582.png)
...
![image-20240411090300100](../image/chapter22/image-20240411090300100.png)

类一直在往上增加

![image-20240411090131039](../image/chapter22/image-20240411090131039.png)
...
![image-20240411121859116](../image/chapter22/image-20240411121859116.png)
...
#### 22.6.3.4 monitor/watch/trace相关
...
* profiler/火焰图
  ...
  * ![image-20240412123032049](../image/chapter22/image-20240412123032049.png)

  * ![image-20240412123100409](../image/chapter22/image-20240412123100409.png)
...
![image-20240415193529634](../image/chapter22/image-20240415193529634.png)
...
![image-20240415194929110](../image/chapter22/image-20240415194929110.png)

可以设置告警

![image-20240415194958508](../image/chapter22/image-20240415194958508.png)

### 22.7.5 Java Flight Recorder

![image-20240415195109380](../image/chapter22/image-20240415195109380.png)
...
* 启动方式
  * 方式一：使用-XX:StartFlightRecoding=参数
    ...
    ![image-20240416080403011](../image/chapter22/image-20240416080403011.png)
  
  * 方式二：使用jcmd的JFR.*子命令
  
    ![image-20240416080551784](../image/chapter22/image-20240416080551784.png)
  
  * 方式三：JMC的JFR插件
  
    ![image-20240416080612719](../image/chapter22/image-20240416080612719.png)
* Java Flight Recoder取样分析
  * 要采用取样，java程序启动时JVM必须先添加参数，否则启动飞行记录仪会报错。
...
### 22.8.1 Flame Graphs(火焰图)

​	在追求极致性能的场景下，了解你的程序运行过程中cpu在干什么很重要，火焰图就是一种非常直观的展示cpu在程序整个生命周期过程中时间分配的工具。

​	火焰图对于现代程序员不应该陌生，这个工具可以非常直观的显示出调用栈中的cpu消耗瓶颈。

​	火焰图讲解大部分来自Brendan Gregg的博客：http://www.brendangregg.com/flamegraphs.html

![image-20240416081420357](../image/chapter22/image-20240416081420357.png)

### 22.8.2 Tprofiler

![image-20240416081805904](../image/chapter22/image-20240416081805904.png)

https://github.com/alibaba/TProfiler

### 22.8.3 Btrace

![image-20240416082019414](../image/chapter22/image-20240416082019414.png)

### 22.8.4 YourKit

### 22.8.5 JProbe

### 22.8.6 Spring Insight