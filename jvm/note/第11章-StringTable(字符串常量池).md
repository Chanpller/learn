...
4. String在jdk8及以前内部定义了`final char value[]`用于存储字符串数据。JDK9时改为`byte[]`（因为char占用2字节，byte占用1字节，有些不必要占用两个字节的可以节约空间，通过byte[]加上编码标记，也就是字符集来确认byte中的字符了）。

### 11.1.1为什么 JDK9 改变了 String 的结构
...
<img src="../image/chapter11/0001.png">

<img src="../image/chapter11/0002.png">
...
<img src="../image/chapter11/0003.png">

<img src="../image/chapter11/0004.png">

### 11.2.1 StringTable 为什么要调整？
...
<img src="../image/chapter11/0005.png">

2、加载了一个换行符（println），所以多了一个

<img src="../image/chapter11/0006.jpg">

3、加载了字符串常量 “1”~“9”

<img src="../image/chapter11/0007.jpg">

4、加载字符串常量 “10”

<img src="../image/chapter11/0008.jpg">

5、之后的字符串"1" 到 "10"不会再次加载

<img src="../image/chapter11/0009.png">
...
class Memory {
    ...
    private void foo(Object param) {//line 6
        String str = param.toString();//line 7 toString会将字符串放入常量池中
...
<img src="../image/chapter11/0010.png">
...
<img src="../image/chapter11/0011.png">
...
```java
    ...
    //toString是new String(char['a','b'])
    //new String("ab")会在常量池放“ab”字符串，再创建一个new String(char['a','b'])的对象。
...
### 11.5.2 new String() 的说明

#### 11.5.2.1 new String(“ab”)会创建几个对象？
...
#### 11.5.2 new String(“a”) + new String(“b”) 会创建几个对象？
...
<img src="../image/chapter11/0012.png">
...
<img src="../image/chapter11/0013.png">

JDK7及后续版本，**注意大坑**

<img src="../image/chapter11/0014.png">
...
#### 11.5.3.2 总结String的intern()的使用

* jdk1.6中，将这个字符串对象尝试放入串池。
  
  * 如果串池中有，则并不会放入。返回已有的串池中的对象地址。
  
  * 如果串池没有，会把此对象复制一份，放入串池，并返回串池中的对象地址

* jdk1.7起，将这个字符串对象尝试放入串池
  
  * 如果串池中有，则并不会放入。返回已有的串池中的对象地址。
  - 如果串池没有，则会把此对象的引用地址复制一份，放入串池，并返回串池中的对象地址。这样做的目的是为了节省空间。
...
![image-20201116113423492](../image/chapter11/0015.png)

**JDK7/8**

<img src="../image/chapter11/0016.png">
...
<img src="../image/chapter11/0017.png">
...
<img src="../image/chapter11/0018.png">

<img src="../image/chapter11/0019.png">
...
<img src="../image/chapter11/0020.png" >

<img src="../image/chapter11/0021.png">
...
<img src="../image/chapter11/0022.jpg">

11.7 G1 中的 String 去重操作
-------------------
