...
![image-20231109234635270](../image/0016.png)

**详细图**

英文版

![image-20231109220744668](../image/image-20231109220744668.png)

中文版

![image-20231109220627827](../image/image-20231109220627827.png)
...
![image-20231109221021079](../image/image-20231109221021079.png)
...
![image-20231109221213044](../image/image-20231109221213044.png)
...
![image-20231109221510980](../image/image-20231109221510980.png)

完整的流程图如下所示：

![image-20231109221547801](../image/image-20231109221547801.png)
...
![image-20231109222127842](../image/image-20231109222127842.png)

##### 2.2.3.2.2 准备(Prepare)
...
![image-20231109222255151](../image/image-20231109222255151.png)
...
![image-20231109230245142](../image/image-20231109230245142.png)

加上之后就有了

![image-20231109230403907](../image/image-20231109230403907.png)

**4说明** 

![image-20231109230658391](../image/image-20231109230658391.png)
...
![image-20231109231002521](../image/image-20231109231002521.png)
...
2. 从概念上来讲，自定义类加载器一般指的是程序中由开发人员自定义的一类类加载器，但是Java虚拟机规范却没有这么定义，而是**将所有派生于抽象类ClassLoader(继承这个类的加载器)的类加载器都划分为自定义类加载器**
3. 无论类加载器的类型如何划分，在程序中我们最常见的类加载器始终只有3个，如下所示

![image-20231109231201225](../image/image-20231109231201225.png)

**ExtClassLoader**

![image-20231109231201226](../image/image-20231109231201226.png)

**AppClassLoader**

![image-20231109231201227](../image/image-20231109231201227.png)
...
* 系统类加载器-应用程序类加载器（也称为系统类加载器，AppClassLoader）
...
![image-20231109233002047](../image/image-20231109233002047.png)

sun.misc.Launcher 它是一个java虚拟机的入口应用

![image-20231109233118455](../image/image-20231109233118455.png)

### 2.4.3 获取ClassLoader途径

![image-20231109233207407](../image/image-20231109233207407.png)
...
![image-20231109233623344](../image/image-20231109233623344.png)
...
![image-20231109233834324](../image/image-20231109233834324.png)
...
![image-20231109233945432](../image/image-20231109233945432.png)
...
- 除以上七种情况，其他使用Java类的方式都被看做是对类的被动使用，都不会导致类的初始化。