...
def welcome():    print('你好啊')

print(type(a1)) print(type(a2)) print(type(a3)) print(type(welcome))</code></pre><p id="u2aa2cd1e" class="ne-p">上述代码中`welcome`函数的内存示意图：</p><p id="u723a6f5a" class="ne-p">![img](https://cdn.nlark.com/yuque/0/2025/png/35780599/1763693048384-2969660a-f099-4596-8e02-d8aec6fe9f4a.png)</p></details>
...
welcome.desc = "这是一个用于打招呼的函数" welcome.version = 1.0 print(welcome.**dict**)

# 调用函数

welcome()</code></pre><p id="ub25e9729" class="ne-p">![img](https://cdn.nlark.com/yuque/0/2025/png/35780599/1763694610972-ff1e7b3c-9428-431a-a030-f11a9ce18a3c.png)</p></details>
...
welcome()</code></pre><p id="u40627907" class="ne-p">上述代码的内存结构示意图：</p><p id="uc84e5c67" class="ne-p">![img](https://cdn.nlark.com/yuque/0/2025/png/35780599/1763694650906-edf97831-3257-4023-a552-3a305fc01a96.png)</p></details>
...
a = 666 print(f'函数外侧a的值是：{a}，地址是：{id(a)}') welcome(a) print(f'函数调用后a的值是：{a}，地址是：{id(a)}')</code></pre><pre data-language="python" id="U2cZo" class="ne-codeblock language-python"><code>def welcome(data):    print(f'函数收到的data是：{data}，地址是：{id(data)}')    data[2] = 99    print(f'被修改后的data是：{data}，地址是：{id(data)}')

a = [10, 20, 30] print(f'函数外侧a的值是：{a}，地址是：{id(a)}') welcome(a) print(f'函数调用后a的值是：{a}，地址是：{id(a)}')</code></pre></details>
...
def caller(f):    print('caller函数开始调用')    f()
...
**表达式：**执行后最终能得到一个值的代码，就是表达式，例如这些都是表达式：**条件表达式：** 根据不同的条件，得到不同的值，又称：三元表达式，也叫：三目运算符。



# 传统if-else写法

if age >= 18:    text = '成年' else:    text = '未成年'

# 条件表达式写法

text = '成年' if age >= 18 else '未成年·' print(text)</code></pre><p id="u79b9294d" class="ne-p">3️⃣ 什么时候适合用条件表达式？ —— 简单的二选一场景，可以让代码更紧凑。 </p><pre data-language="python" id="mdPq0" class="ne-codeblock language-python"><code>rain = True food = '外卖' if rain else '出去吃'

is_vip = True disscount = 0.8 if is_vip else 1.0

is_login = True msg = '欢迎回来！' if is_login else '请先登录！'</code></pre></details>
...
备注：`<font style="color:#585A5A;">reduce</font>`函数需要从`<font style="color:#585A5A;">functools</font>`模块中引入才能使用。
...
<!-- 这是一张图片，ocr 内容为： --> ![img](https://cdn.nlark.com/yuque/0/2025/png/35780599/1765148804605-cdf60e16-ae18-4c1b-a382-18bca34c57b2.png)
...
<!-- 这是一张图片，ocr 内容为： --> ![img](https://cdn.nlark.com/yuque/0/2025/png/35780599/1765148836670-e8f2a432-4f2a-4283-95d3-327b3dba9fd2.png)
...
<!-- 这是一张图片，ocr 内容为： --> ![img](https://cdn.nlark.com/yuque/0/2025/png/35780599/1765148879265-cf4aa9c4-c796-45be-bd9d-515b2a2a07ef.png)
...
<!-- 这是一张图片，ocr 内容为： --> ![img](https://cdn.nlark.com/yuque/0/2025/png/35780599/1765148910263-d5d0cdf6-5ced-40fa-8396-40db5b5027be.png)
...
<!-- 这是一张图片，ocr 内容为： --> ![img](https://cdn.nlark.com/yuque/0/2025/png/35780599/1765149103254-8ff8aa0b-2ffd-498f-acbe-9e9537156e47.png)
