...
![img](../image/1760693605673-67877fd2-c41f-4df7-a1a5-912807f65b62.png)
...
![img](../image/1760694207388-5e472a3b-3847-4029-a584-42c6dd14dfa4.png)
...
2. 语法图解：![img](../image/1760695029676-6e6bdbe9-871f-46c5-ac0f-ebc49f5ebc9c.png)
...
![img](../image/1760695358645-c93bb50a-7f5e-4d74-9ffc-f53939bf7025.png)

3. 案例：

![img](../image/1760695996039-6e868c73-2f33-4b8f-b48a-ecd9933bf531.png)
...
4. 案例:![img](../image/1760705999116-d5b56e8b-872e-427a-be86-6bc8f94af8fb.png)
...
```python
# range是一个函数，表示数字在什么区间，前闭后开[1,11),如果省略前面一个就是从0开始,[0,n)
...
4. 案例：实现一个字符串加密程序，大致思路如下图：

![img](../image/1760708051227-3de1c2d0-a4d3-4048-9e64-21cac91a5a9c.png)
...
### 4.2.3 对比 while 与 for![img](../image/1760708359390-ee50e6ac-dcfd-4198-b089-59764208f955.png)

### 4.2.4 嵌套循环

1. 概念：在一个循环的内部，再写一个或多个循环，就是嵌套循环。

2. 案例：实现一个为期 30 天的健身计划，效果如图：

![img](../image/1760708574330-c3a1ca02-1eea-4e7f-bb6f-ec5cebd75ae1.png)
...
![img](../image/1760858756480-4f33c504-87cc-40de-9086-30cd68e6c495.png)

小贴士：print('你好', end='') 中的end用来控制打印后结尾输出的内容，不写默认是\n换行符。
...
![img](../image/1760709841147-1b187d94-c0c1-4cd3-aa37-0488d2079e37.png)
