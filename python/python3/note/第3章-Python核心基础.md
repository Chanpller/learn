...
![](../image/1746586662422-1232a3b9-69df-4fee-8f4b-5f28974bbfe9.png) 
![](../image/1747966924322-0759f53e-74c9-41e2-83d1-1d29a4885591.png) 
![](../image/1747966935103-3e14aaeb-2f53-40b1-a9e6-ec7ace4c060d.png)
...
4. 常见的三种命名风格
   ...
   ![image.png](../image/1747039497952-2b73656f-739b-4735-b758-db370ffecbc5.png)
...
- 存储数据时，计算机会进行编码
- 读取数据时，计算机会进行解码
  ![](../image/1760676361078-7e14538b-66e1-4d50-a783-b89394156146.png)
...
![](../image/1760683740087-1061a968-bbf5-4cb2-8f29-4371145a7656.png)



* 对于浮点类型，m控制输出的整体最小长度，超过则不管，如果不够，根据符号在左边或右边添加空格；n控制保留多少位小数，不够补0

![](../image/1760683810967-f13c72b1-b5f4-4484-9cd7-dd5a960a2954.png)



* 对于整数，m控制输出的整体最小长度，超过则不管，如果不够，根据符号在左边或右边添加空格；n控制输入的数字是多少位，不够的补0

![](../image/1760683825654-121576f3-7ef3-40e7-bfcf-a1123a89c785.png)
...
* \t默认以4个字符为一个基准进行分割，就是1234这种，所以制表符的空格不确定有几位，是为了对齐4位

* 一个汉字占2个格子

* 需要固定几个空格字符串后面添加.expandtabs(4)方法。

  ![image-20260307162712174](../image/image-20260307162712174.png)
...
| 函数 | 说明 | 示例 |
| --- | --- | --- |
| int(x) | 将x转换为一个整数 |![](../image/1760685873454-38c2d74a-8af0-414a-b15d-22bbe4340282.png)|
| float(x) | 将x转换为一个浮点数 |![](../image/1760685983761-4fc9e5ee-42b8-4777-adc6-f5d27e540d26.png)|
| str(x) | 将对象x转换为一个字符串 |![](../image/1760686026401-a1c44b32-3eab-4357-8638-e36465f34a5f.png)|
...
![](../image/1760841632719-f732761c-8094-47b7-8dc2-003b6c4112ca.png)
...
![](../image/1760686233255-90bec728-4fda-4a50-9e1c-338b541b2438.png)
...
![](../image/1760841758156-fabfcb66-072e-4a4e-91c4-4c69063c084e.png)
...
![](../image/1760688683540-8b0ab28b-5d77-4128-805b-535f25a816d9.png)
...
![](../image/1760689095171-e9774770-38be-4d1b-a117-70ad015b5084.png)

但布尔类型的具体值，只有两个，分别是：True和False，其中：True表示真，False表示假。


![](../image/1760689122751-f2e8c455-920c-464c-8e3e-aaed34394f22.png)
...
布尔类型是int类型的子类型，底层的本质是用1表示True，用0表示False，所以可以对布尔类型进行计算。
...
![](../image/1760842774737-97fad10e-bf66-4bc6-9918-513b0b2ba8ff.png)

1. and 运算符：用于判断其两侧的值，是否都为True
...
2. or 运算符：用于判断其两侧，是否至少有一个为True（只要有一个是True，那就返回True）
...
3. not 运算符：not用于取反，不过要注意：如果参与not运算的值不是布尔值，那 Python 会自动将其转为布尔值，然后再进行逻辑操作。
...
![十进制数：9527](../image/1760689897490-ff8343ae-f99c-4890-a68c-eb7f8efcffa1.png)
![二进制数：1010](../image/1760689918264-dea18369-a570-45ec-84c7-5df68292e440.png)

![八进制数：1034](../image/1760690227879-a8ed7844-3c58-43db-b217-139a31d4154a.png)
![十六进制数：1CF](../image/1760690187335-20e1de59-45d2-4f50-9b37-c5819de5169a.png)
...
![](../image/1760691227071-04f27f9d-bbe6-4f20-9abd-2efa5af9bc20.png)

2. 借助 Python 提供的内置函数，实现进制转换


![](../image/1760847827120-d88d2ba5-bd04-4b4d-9b0e-ba91982d9f0c.png)
